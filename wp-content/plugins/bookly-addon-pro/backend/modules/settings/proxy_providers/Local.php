...
class Local extends Proxy\Pro
{
     ...
     * @inheritDoc
     */
    public static function renderAppointmentsMenuItem()
    {
        Menu::renderItem( __( 'Appointments', 'bookly' ), 'appointments' );
    }

    /**
     * @inheritDoc
     */
    public static function renderAppointmentsTab()
    {
        $slot_lengths = array(
        ...
        self::renderTemplate( 'appointments_tab', compact( 'slot_lengths' ) );
    }
}